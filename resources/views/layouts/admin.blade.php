      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            <li class="header"></li>
              <ul class="treeview">
                <li><a href="{{ route('producto.index') }}"><i class="fa fa-filter" aria-hidden="true"></i>Productos</a></li>
                <br>
                <li><a href="{{ route('empresa.index') }}"><i class="fa fa-filter" aria-hidden="true"></i>Empresa</a></li>
                <br>
